...
class ProductTest extends TestCase
{
    ...
    public function test_store_product_with_no_image(): void {
        ...
        $request = ['item_name' => 'Apple', 'plu_cd' => '49504319234302', 'item_price' => '444', 'item_desc' => 'An apple.', 'category' => 'Test'];
    ...
    public function test_store_product_with_image(): void {
        ...
        // Send the request via the add route.
        $request = ['item_name' => 'Apple', 'plu_cd' => '49504319234302', 'item_price' => '444', 'item_desc' => 'An apple.', 'item_img' => $file, 'category' => 'Test'];
        $this->followingRedirects()->post('/admin/products/add', $request)->assertStatus(200);
    ...
    public function test_store_product_with_empty_item_name(): void {
        // Send the request via the add route.
        $request = ['item_name' => '', 'plu_cd' => '49504319234302', 'item_price' => '444', 'item_desc' => 'An apple.', 'category' => 'Test'];
    ...
    public function test_store_product_with_empty_plu_cd(): void {
        // Send the request via the add route.
        $request = ['item_name' => 'Apple', 'plu_cd' => '', 'item_price' => '444', 'item_desc' => 'An apple.', 'category' => 'Test'];
        $response = $this->followingRedirects()->post('/admin/products/add', $request);
    ...
    public function test_store_product_with_invalid_plu(): void {
        // Send the request via the add route.
        $request = ['item_name' => 'Apple', 'plu_cd' => 'abc', 'item_price' => '444', 'item_desc' => 'An apple.', 'category' => 'Test'];
        $response = $this->followingRedirects()->post('/admin/products/add', $request);
    ...
    public function test_store_product_with_empty_price(): void {
        // Send the request via the add route.
        $request = ['item_name' => 'Apple', 'plu_cd' => '49504319234302', 'item_price' => '', 'item_desc' => 'An apple.', 'category' => 'Test'];
        $response = $this->followingRedirects()->post('/admin/products/add', $request);
    ...
    public function test_store_product_with_invalid_price(): void {
        // Send the request via the add route.
        $request = ['item_name' => 'Apple', 'plu_cd' => '49504319234302', 'item_price' => 'abc', 'item_desc' => 'An apple.', 'category' => 'Test'];
        $response = $this->followingRedirects()->post('/admin/products/add', $request);
    ...
    public function test_flush_category(): void {
        ...
        $request = ['item_name' => 'Target', 'plu_cd' => '49504319234302', 'item_price' => '444', 'item_desc' => 'Delete me!', 'category' => 'DeleteMe'];
        $this->followingRedirects()->post('/admin/products/add', $request)->assertStatus(200);
